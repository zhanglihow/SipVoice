...
public class SipCall extends Call {
    ...
    public pjsip_inv_state getCurrentState() {
        try {
            ...
            TyLog.e("Error while getting call Info:"+exc);
    ...
    public void onCallState(OnCallStateParam prm) {
        try {
            ...
            if (callState == pjsip_inv_state.PJSIP_INV_STATE_DISCONNECTED) {
                TyLog.i("sip state=disconnect");
                account.getService().setLastCallStatus(0);
                delete();
            }

        } catch (Exception exc) {
            TyLog.e("onCallState: error while getting call info:"+exc);
        }
    ...
    public void onCallMediaState(OnCallMediaStateParam prm) {
        ...
        try {
            ...
            TyLog.e("onCallMediaState: error while getting call info:"+ exc);
            return;
        }
    ...
    public void onCallMediaEvent(OnCallMediaEventParam prm) {
        if (prm.getEv().getType() == pjmedia_event_type.PJMEDIA_EVENT_FMT_CHANGED) {
            ...
            try {
                ...
                TyLog.e( "Unable to get video dimensions:"+ex);
            }
        }
    ...
    public void acceptIncomingCall() {
        ...
        try {
            ...
            TyLog.e( "Failed to accept incoming call:"+exc);
        }
    }
    ...
    public void sendBusyHereToIncomingCall() {
        ...
        try {
            ...
            TyLog.e( "Failed to send busy here:"+exc);
        }
    }
    ...
    public void declineIncomingCall() {
        ...
        try {
            ...
            TyLog.e( "Failed to decline incoming call:"+exc);
        }
    }
    ...
    public void hangUp() {
        ...
        try {
            ...
            TyLog.e( "Failed to hangUp call:"+exc);
        }
    }
    ...
    public void setMute(boolean mute) {
        ...
        try {
            ...
            TyLog.e( "setMute: error while getting call info:"+exc);
            return;
        }
        ...
        for (int i = 0; i < info.getMedia().size(); i++) {
            ...
            if (mediaInfo.getType() == pjmedia_type.PJMEDIA_TYPE_AUDIO
                ...
                try {
                    ...
                    TyLog.e( "setMute: error while connecting audio media to sound device:"+exc);
                }
            }
        }
    }
    ...
    public void setHold(boolean hold) {
        ...
        try {
            ...
            TyLog.e( "Error while trying to " + operation + " call:"+exc);
        }
    }
        ...
        try {
            ...
            if (audioMedia != null) {
                try {
                    ...
                    TyLog.e( "Error while adjusting levels:"+exc);
                }
            ...
            TyLog.e( "Error while connecting audio media to sound device:"+exc);
        }
    }
    ...
    public void setIncomingVideoFeed(Surface surface) {
        if (mVideoWindow != null) {
            ...
            try {
                ...
                TyLog.e( "Unable to setup Incoming Video Feed:"+ex);
            }
        }
    }
    ...
    public void startPreviewVideoFeed(Surface surface) {
        if (mVideoPreview != null) {
            ...
            try {
                ...
                TyLog.e( "Unable to start Video Preview:"+ex);
            }
        }
    }
    ...
    public void stopIncomingVideoFeed() {
        ...
        if (videoWindow != null) {
            try {
                ...
                TyLog.e( "Unable to stop remote video feed:"+ex);
            }
        }
    }
    ...
    public void stopPreviewVideoFeed() {
        ...
        if (videoPreview != null) {
            try {
                ...
                TyLog.e( "Unable to stop preview video feed:"+ex);
            }
        }
    }
    ...
    public void setVideoMute(boolean videoMute) {
        try {
            ...
            TyLog.e( "Error while toggling video transmission:"+ex);
        }
    }
    ...
    private Runnable sendKeyFrameRunnable = new Runnable() {
        ...
        public void run() {
            try {
                ...
                TyLog.e( "error while sending periodic keyframe");
            }
        }
    };
