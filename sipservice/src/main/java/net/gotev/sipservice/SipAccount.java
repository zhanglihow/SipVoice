...
public class SipAccount extends Account {
    ...
    protected void removeCall(int callId) {
        ...
        if (call != null) {
            TyLog.d("Removing call with ID: " + callId);
    ...
    public SipCall addIncomingCall(int callId) {
        ...
        TyLog.d("Added incoming call with ID " + callId + " to " + data.getIdUri());
        return call;
    }
    ...
    public SipCall addOutgoingCall(final String numberToDial, boolean isVideo, boolean isVideoConference) {
        ...
        if (totalCalls == 0) {
            ...
            try {
                ...
                TyLog.d("New outgoing call with ID: " + call.getId());
        ...
        TyLog.i("totalCalls.size="+totalCalls);
        return null;
    }
    ...
    public void onIncomingCall(OnIncomingCallParam prm) {
        ...
        if (service.isDND()) {
            try {
                ...
                TyLog.d("Decline call with ID: " + prm.getCallId());
            } catch(Exception ex) {
                TyLog.e("Error while getting missed call info:"+ex);
            }
            return;
        }
        ...
        if (totalCalls > 1) {
            try {
                ...
                TyLog.d("Sending busy to call ID: " + prm.getCallId());
            } catch(Exception ex) {
                TyLog.e("Error while getting missed call info:"+ex);
            }
            return;
        ...
        try {
            ...
            try {
                ...
                TyLog.e("Error while getting caller info:"+ex);
            }
